...
public interface PropertyResolver {
	 ...
	 */
	String resolvePlaceholders(String text);//Tip:没法替换的占位符将被忽略
	 ...
	 */
	String resolveRequiredPlaceholders(String text) throws IllegalArgumentException;//Tip:没法替换占位符则抛出异常
