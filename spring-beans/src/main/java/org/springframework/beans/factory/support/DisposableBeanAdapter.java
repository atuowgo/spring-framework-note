...
class DisposableBeanAdapter implements DisposableBean, Runnable, Serializable {
	...
	public DisposableBeanAdapter(Object bean, String beanName, RootBeanDefinition beanDefinition,
		...
		this.beanPostProcessors = filterPostProcessors(postProcessors, bean);//Tip:需要处理该bean的DestructionAwareBeanPostProcessor回调列表
	}
	...
	public void destroy() {
		if (!CollectionUtils.isEmpty(this.beanPostProcessors)) {
			for (DestructionAwareBeanPostProcessor processor : this.beanPostProcessors) {
				processor.postProcessBeforeDestruction(this.bean, this.beanName);/*Tip:全局回调，销毁bean前进行通知,DestructionAwareBeanPostProcessor.postProcessBeforeDestruction*/
			}
		}

		if (this.invokeDisposableBean) {/*Tip:销毁回调,如果实现了DisposableBean，先执行destroy方法.DisposableBean.destroy*/
		...
		if (this.destroyMethod != null) {/*Tip:销毁回调,执行自定义的销毁方法,destroy-method*/
